...
// TODO: Lowerにある記号の中にRaiseレイヤ+シフトで入力できる記号が含まれている。これらを消してLowerで使えるキーを空ける
//     : また、ホームポジション付近をRaiseで記号にしているのに、上の方では数値になっており、数値と重なる記号は1行目のキーをShiftで入力するか、
//     : Lowerと組み合わせて入力することになっている。記号がRaiseとLowerに分散していて分かりづらいのでRaiseにまとめる
/* Raise
 * ,-----------------------------------------.             ,-----------------------------------------.
